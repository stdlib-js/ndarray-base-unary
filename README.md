...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-base-unary/tags). For example,

```javascript
unary = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-unary@v0.3.0-umd/browser.js' )
```
